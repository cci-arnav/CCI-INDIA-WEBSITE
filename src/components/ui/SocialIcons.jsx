...
export function YoutubeIcon({ size = 16, className = '' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      <path d="M2.5 8.5c0-1.5 1-2.5 2.5-2.8C7.5 5 12 5 12 5s4.5 0 7 .7c1.5.3 2.5 1.3 2.5 2.8v7c0 1.5-1 2.5-2.5 2.8-2.5.7-7 .7-7 .7s-4.5 0-7-.7c-1.5-.3-2.5-1.3-2.5-2.8v-7z" />
